          ...
          <Container styles="flex flex-col md:flex-row items-center md:items-start gap-8 mt-8">
            ...
            <article className="w-full md:w-2/3 p-6 rounded-lg shadow-lg">
              ...
              <p className="mb-4 text-md leading-relaxed">
                Fundada em 29 de maio de 2019, na cidade de Içara, Santa
                Catarina, a Gráfica 3FC nasceu do espírito empreendedor de
                Fernando Furlan Felisberto e Camila Biava Rocha. Desde o início,
                a empresa foi guiada por um propósito claro: unir o profundo
                conhecimento técnico sobre produtos e processos à criatividade
                no design, para oferecer soluções de alta qualidade em rótulos e
                etiquetas personalizadas. Nosso compromisso vai além da simples
                produção de materiais gráficos; buscamos transformar ideias em
                realidade, ajudando marcas a se destacarem no mercado.
              </p>

              <p className="mb-4 text-md leading-relaxed">
                Com uma abordagem centrada na satisfação do cliente, a Gráfica
                3FC tem se destacado por entender as necessidades de cada
                parceiro e entregar produtos que agregam valor às marcas e ao
                mercado. A atenção aos detalhes, o compromisso com a excelência
                e o constante investimento em tecnologia garantem que cada
                projeto seja realizado com precisão e inovação. Valorizamos a
                proximidade com nossos clientes, ouvindo suas demandas e
                desenvolvendo soluções sob medida para atender às expectativas
                mais exigentes.
              </p>
              ...
              <p className="mb-4 text-md leading-relaxed">
                ...
                pensado para refletir o melhor de cada marca, combinando
                materiais de alta qualidade, acabamentos diferenciados e designs
                impactantes. Nossa equipe de especialistas está sempre
                atualizada com as principais tendências do setor, garantindo que
                cada projeto seja único e memorável.
              </p>

              <p className="text-md leading-relaxed">
                Nosso crescimento é impulsionado por um compromisso contínuo com
                a inovação e a sustentabilidade. Buscamos constantemente novas
                tecnologias e práticas ecológicas para minimizar o impacto
                ambiental de nossa produção, adotando processos mais eficientes
                e responsáveis. Com isso, não apenas entregamos produtos de
